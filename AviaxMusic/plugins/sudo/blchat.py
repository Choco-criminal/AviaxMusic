...
@app.on_message(filters.command(["mblchat", "mblacklistchat"]) & SUDOERS)
@language
...
@app.on_message(
    filters.command(["mwhitelistchat", "munblacklistchat", "munblchat"]) & SUDOERS
)
@language
...
@app.on_message(filters.command(["mblchats", "mblacklistedchats"]) & ~BANNED_USERS)
@language
